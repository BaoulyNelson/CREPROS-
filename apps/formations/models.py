"""Modèles liés aux sessions de formation organisées par le centre."""
...
class Formation(models.Model):
    ...
    duree = models.CharField(
        "Durée", max_length=100, help_text="Exemple : 3 jours, 20 heures"
    )
    ...
    image = models.ImageField(
        "Image", upload_to="formations/images/", blank=True, null=True
    )
    ...
    statut = models.CharField(
        "Statut", max_length=20, choices=Statut.choices, default=Statut.A_VENIR
    )
...
class InscriptionFormation(models.Model):
    ...
    organisation = models.CharField(
        "Organisation / Institution", max_length=200, blank=True
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["formation", "email"], name="inscription_unique_par_formation"
            )
        ]
